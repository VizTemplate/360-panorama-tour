...
> _Для добавления скриншотов или GIF-анимаций панорам, помести изображения в папку `assets/` и обновите ссылки ниже._

![Панорама Ванная](https://via.placeholder.com/800x400?text=360°+Panorama+Screenshot)
*Интерактивная панорама ванной комнаты — ЖК Акватория*
